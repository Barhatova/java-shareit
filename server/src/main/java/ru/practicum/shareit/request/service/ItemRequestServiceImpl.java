...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    public Collection<ItemRequestDto> getUserRequests(Integer userId) {
        userService.getUserById(userId);
        Collection<ItemRequestDto> list = new ArrayList<>();
        Collection<ItemRequest> getAllByCreatorIdOrderByCreatedDesc = itemRequestRepository
                .getByCreatorIdOrderByCreatedDesc(userId);
        getAllByCreatorIdOrderByCreatedDesc.forEach(i -> {
